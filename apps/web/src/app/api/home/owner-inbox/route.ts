...
import { loadOwnerInbox } from "../../../../features/home/owner-home-data";
...
export async function GET(request: NextRequest) {
  try {
    ...
    return NextResponse.json(await loadOwnerInbox({
      workspaceId,
      repository: createSupabaseConversationsInboxRepository(supabase),
      limit: 6,
    }));
  } catch (error) {
    console.error("GET /api/home/owner-inbox error:", error);
