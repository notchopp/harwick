...
import { loadVoiceHandoffQueue } from "../../../../../features/operator-queues/operator-queues";
...
export async function GET(request: NextRequest, context: RouteContext) {
  ...
  const queueInput: Parameters<typeof loadVoiceHandoffQueue>[0] = {
    workspaceId,
  ...
  const queue = await loadVoiceHandoffQueue(queueInput);
