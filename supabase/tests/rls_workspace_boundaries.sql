...
values
  ...
  ('conversation_messages', 'conversation_messages_read_workspace', false),
  ('conversation_messages', 'conversation_messages_insert_workspace', true),
  ...
  ('audit_logs', 'workspace admins can read audit logs', false),
  ('audit_logs', 'workspace admins can insert audit logs', true),
  ('workspace_subscriptions', 'workspace owners can read subscription', false),
  ('workspace_subscriptions', 'workspace owners can manage subscription', true),
  ('workspace_usage_events', 'workspace admins can read usage events', false),
  ('workspace_usage_summaries', 'workspace admins can read usage summaries', false),
  ('member_routing_profiles', 'workspace members can read routing profiles in their workspace', false),
  ('member_routing_profiles', 'routing managers can insert routing profiles', true),
  ('member_routing_profiles', 'routing managers can update routing profiles', true),
  ('member_routing_profiles', 'routing managers can delete routing profiles', false),
  ('agent_trajectories', 'agent_trajectories_workspace_read', false),
  ('agent_steps', 'agent_steps_workspace_read', false),
  ('agent_outcomes', 'agent_outcomes_workspace_read', false),
  ('harwick_routing_decisions', 'harwick_routing_decisions_workspace_read', false),
  ('harwick_routing_decisions', 'harwick_routing_decisions_workspace_manage', true),
  ('harwick_work_items', 'harwick_work_items_workspace_read', false),
  ('harwick_work_items', 'harwick_work_items_workspace_manage', true),
  ('workspace_memory_documents', 'workspace_memory_documents_workspace_read', false),
  ('workspace_memory_documents', 'workspace_memory_documents_workspace_manage', true),
  ('harwick_subagent_tasks', 'harwick_subagent_tasks_workspace_read', false),
  ('harwick_subagent_tasks', 'harwick_subagent_tasks_workspace_manage', true),
  ('harwick_loops', 'harwick_loops_workspace_read', false),
  ('harwick_loops', 'harwick_loops_workspace_manage', true),
  ('harwick_loop_runs', 'harwick_loop_runs_workspace_read', false),
  ('harwick_loop_runs', 'harwick_loop_runs_workspace_manage', true),
  ('billing_webhook_events', 'workspace owners can read billing webhook events', false),
  ('workspace_member_calendar_connections', 'workspace members can read permitted calendar connections', false),
  ('workspace_member_calendar_connections', 'calendar connections manage', true);
